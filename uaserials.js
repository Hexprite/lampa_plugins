(function(){
    ...
    function uaSerials(){
        ...
        Lampa.Component.add('uaserials_menu', {
            ...
            render: function(){
                if(!this._render){
                    this._render = $('<div class="activity"></div>');
                }
                return this._render;
            }
        });
