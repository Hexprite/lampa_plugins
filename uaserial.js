// uaserials.js — готовий плагін для Lampa з пунктом на першому місці
(function(){
    'use strict';
    ...
    function uaSerials(){
        ...
        Lampa.Listener.follow('app', function(e){
            if(e.type === 'ready'){
                ...
                setTimeout(()=>{
                    ...
                    if(Lampa.Menu.list) Lampa.Menu.list.unshift(newItem);
                    Lampa.Menu.render();
        ...
        // Додай сюди компоненти списку серіалів, деталей, сезонів та серій
        // uaserials_list, uaserials_details, uaserials_seasons, uaserials_serial
        // Їх можна вставити з останньої робочої версії плагіна
    }
